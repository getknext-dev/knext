...
| **v1.3.0** | System designer | **6** | **6** | **6** |
| **v1.3.0** | DevOps/SRE | **6** | **6** | **5** |
| **v1.3.0** | Architect | **8** | **6** | **6** |
...
**v1.3.0 zone-axis release review (trigger-gated): maturity 6.7, ease 6.0,
reliability 5.7.** (Originally tagged v2.0.0 on milestone reasoning; retagged
v1.3.0 per strict semver — the zone axis is additive/non-breaking. v2.0.0 reserved
for a genuine breaking change, e.g. cross-cluster or a DATABASE_URL contract change.)
Architect SIGN-OFF — "architecturally defensible v2 for its
...
The v1.3.1 hardening list: deploy the zone operator + CRD to live with soak (#151);
...
doesn't cover the new zone surface. None retract v1.3.0; all are the v1.3.1 lap.