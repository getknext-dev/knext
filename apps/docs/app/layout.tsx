...
export const metadata = {
  ...
  description:
    'knext is the scale-to-zero Next.js deployment framework for Knative. Compiled single-binary apps with a ~61 ms process boot, suite-verified compatibility, multi-cloud — no lock-in.',
};
